"""
Django settings for web_sec_project project.
...
SECRET_KEY = 'django-insecure-!pn0#%&6=w^#k%&xrw=73sbi7$w6s4aeli9jsd#s8z(dmfzqo('
...
ROOT_URLCONF = 'web_sec_project.urls'
...
WSGI_APPLICATION = 'web_sec_project.wsgi.application'
...
SESSION_COOKIE_SECURE = True  # Ensures secure session cookie (requires HTTPS)
